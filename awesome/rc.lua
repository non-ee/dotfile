...
local function auto_focus_urgent(c)
	c.minimized = false
	c:jump_to()
end

client.connect_signal("focus", move_mouse_onto_focused_client)
client.connect_signal("property::urgent", auto_focus_urgent)

-- }}

-- autostart
local path = "/home/babyshark/.config/awesome/autostart.sh"
awful.util.spawn_with_shell(path)
